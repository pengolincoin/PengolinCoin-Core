Contributing to PENGOLINCOIN Core
============================

The PENGOLINCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/pengolincoin-project/pengolincoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PENGOLINCOIN Core project, and is not to be
confused with overall PENGOLINCOIN Network Protocol consensus changes.

Whether a pull request is merged into PENGOLINCOIN Core rests with the project merge
...
Patches that change PENGOLINCOIN consensus rules are considerably more involved than
normal because they affect the entire pgosystem and so must be preceded by
...
Where a patchset proposes to change the PENGOLINCOIN consensus, it must have been
...
The project leader is the release manager for each PENGOLINCOIN Core release.
