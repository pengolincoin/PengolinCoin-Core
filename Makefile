...
pkgdatadir = $(datadir)/pengolincoin
pkgincludedir = $(includedir)/pengolincoin
pkglibdir = $(libdir)/pengolincoin
pkglibexecdir = $(libexecdir)/pengolincoin
...
CONFIG_HEADER = $(top_builddir)/src/config/pengolincoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/pengolincoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
ARM_CRC_CXXFLAGS = 
AUTOCONF = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master/build-aux/missing automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = pengolincoin-cli
BITCOIN_DAEMON_NAME = pengolincoind
BITCOIN_GUI_NAME = pengolincoin-qt
BITCOIN_TX_NAME = pengolincoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = pengolincoin
PACKAGE_BUGREPORT = https://github.com/pengolincoin-project/pengolincoin/issues
PACKAGE_NAME = PENGOLINCOIN Core
PACKAGE_STRING = PENGOLINCOIN Core 3.0.0.1
PACKAGE_TARNAME = pengolincoin
PACKAGE_URL = https://www.pengolincoin.xyz/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master
abs_srcdir = /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master
abs_top_builddir = /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master
abs_top_srcdir = /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-23_PengolinCoin/works/Ubuntu_works/PengolinCoin-src-master/build-aux/install-sh
...
srcdir = .
subdirs =  src/univalue src/chiabls src/secp256k1
...
DIST_CONTRIB = $(top_srcdir)/contrib/pengolincoin-cli.bash-completion \
	       $(top_srcdir)/contrib/pengolincoin-tx.bash-completion \
	       $(top_srcdir)/contrib/pengolincoind.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/pengolincoin.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/pengolincoin16.xpm \
  $(top_srcdir)/share/pixmaps/pengolincoin32.xpm \
  $(top_srcdir)/share/pixmaps/pengolincoin128.png
...
COVERAGE_INFO = baseline.info \
  test_pengolincoin_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_pengolincoin_coverage.info test_pengolincoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/PENGOLINCOIN-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings \
...
src/config/pengolincoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/pengolincoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/pengolincoin-config.h
$(top_srcdir)/src/config/pengolincoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/pengolincoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/PENGOLINCOIN-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PENGOLINCOIN-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PENGOLINCOIN-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_pengolincoin.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_pengolincoin -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_pengolincoin_filtered.info: test_pengolincoin.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_pengolincoin_filtered.info
...
#test_pengolincoin_coverage.info: baseline_filtered.info test_pengolincoin_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_pengolincoin_filtered.info -o $@

#total_coverage.info: test_pengolincoin_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_pengolincoin_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_pengolincoin.coverage/.dirstamp:  test_pengolincoin_coverage.info
...
#cov: test_pengolincoin.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_pengolincoin.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
