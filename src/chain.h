...
// New serialization introduced with 2.0.1
static const int DBI_OLD_SER_VERSION = 2000000;
static const int DBI_SER_VERSION_NO_ZC = 2000002;   // removes mapZerocoinSupply, nMoneySupply
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        if (nSerVersion >= DBI_SER_VERSION_NO_ZC) {
            // Serialization with CLIENT_VERSION = 2000002+
            ...
            // Serialization with CLIENT_VERSION = 2000001
