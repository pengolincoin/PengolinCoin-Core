...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PengolinCoin Core pengolincoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pengolincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pengolincoin transaction") + "\n" +
                               "  pengolincoin-tx [options] -create [commands]   " + _("Create hex-encoded pengolincoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pengolincoin transaction
