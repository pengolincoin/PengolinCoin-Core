...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " pengolincoin-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  pengolincoin-tx [options] <hex-tx> [commands]  Update hex-encoded pengolincoin transaction\n" +
                               "or:     pengolincoin-tx [options] -create [commands]   Create hex-encoded pengolincoin transaction\n" +
                               "\n";
