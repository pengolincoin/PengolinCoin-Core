 ...
 * PENGOLINCOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int PengolinCoinBadBlockTime() const { return nPengolinCoinBadBlockTime; }
    int PengolinCoinBadBlocknBits() const { return nPengolinCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nPengolinCoinBadBlockTime;
    unsigned int nPengolinCoinBadBlocknBits;
