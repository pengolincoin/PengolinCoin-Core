...
#ifndef PENGOLINCOIN_ZPGOWALLET_H
#define PENGOLINCOIN_ZPGOWALLET_H
...
public:
    CzPGOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPGO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPGO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //PENGOLINCOIN_ZPGOWALLET_H
