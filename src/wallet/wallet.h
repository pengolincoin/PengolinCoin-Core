...
#ifndef PENGOLINCOIN_WALLET_H
#define PENGOLINCOIN_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_PENGOLINCOIN = 61000, // inherited version..
...
public:
     ...
     * PENGOLINCOIN: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 100,000 PGO output and keys which can be used for the Masternode
