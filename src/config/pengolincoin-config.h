/* src/config/pengolincoin-config.h.  Generated from pengolincoin-config.h.in by configure.  */
/* src/config/pengolincoin-config.h.in.  Generated from configure.ac by autoheader.  */
