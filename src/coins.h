...
/** 
    ...
    ****Note - for PENGOLINCOIN we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of pengolincoin coming in to a transaction
