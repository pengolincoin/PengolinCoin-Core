...
/**
 * Count PGOSA signature operations the old-fashioned (pre-0.6) way
...
/**
 * Count PGOSA signature operations in pay-to-script-hash inputs.
 *
 * @param[in] mapInputs Map of previous transactions that have outputs we're spending
