...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop PENGOLINCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "PENGOLINCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PENGOLINCOIN features */
        {"pengolincoin", "listmasternodes", &listmasternodes, true, true, false},
        {"pengolincoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pengolincoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pengolincoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pengolincoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pengolincoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pengolincoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pengolincoin", "masternodedebug", &masternodedebug, true, true, false},
        {"pengolincoin", "startmasternode", &startmasternode, true, true, false},
        {"pengolincoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pengolincoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pengolincoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pengolincoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pengolincoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pengolincoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pengolincoin", "preparebudget", &preparebudget, true, true, false},
        {"pengolincoin", "submitbudget", &submitbudget, true, true, false},
        {"pengolincoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pengolincoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pengolincoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pengolincoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pengolincoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pengolincoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pengolincoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pengolincoin", "checkbudgets", &checkbudgets, true, true, false},
        {"pengolincoin", "mnsync", &mnsync, true, true, false},
        {"pengolincoin", "spork", &spork, true, true, false},
        {"pengolincoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // {"zerocoin", "getzpgoseed", &getzpgoseed, false, false, true},
        // {"zerocoin", "setzpgoseed", &setzpgoseed, false, false, true},
        // {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        // {"zerocoin", "searchdzpgo", &searchdzpgo, false, false, true},
        // {"zerocoin", "dzpgostate", &dzpgostate, false, false, true},
...
{
    return "> pengolincoin-cli " + methodname + " " + args + "\n";
}
