...
#include "qt/pengolincoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/pengolincoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PENGOLINCOINGUI* _window, QWidget *parent) :
