...
#include "qt/pengolincoin/settings/settingsnetworkwidget.h"
#include "qt/pengolincoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/pengolincoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PENGOLINCOINGUI* _window, QWidget *parent) :
