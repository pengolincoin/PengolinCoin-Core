...
#include "qt/pengolincoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(PENGOLINCOINGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("PENGOLINCOIN_tx_csv_export(*.csv)") : tr("PENGOLINCOIN_addresses_csv_export(*.csv)"),
                                        nullptr);
