...
#include "qt/pengolincoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/pengolincoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PENGOLINCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PENGOLINCOINGUI::handleRestart()
