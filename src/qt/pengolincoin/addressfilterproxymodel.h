...
#ifndef PENGOLINCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define PENGOLINCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //PENGOLINCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
