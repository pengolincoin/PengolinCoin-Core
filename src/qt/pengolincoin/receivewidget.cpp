...
#include "qt/pengolincoin/forms/ui_receivewidget.h"
...
#include "qt/pengolincoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(PENGOLINCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive PGO."));
