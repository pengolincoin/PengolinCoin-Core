...
#ifndef PENGOLINCOIN_CORE_NEW_GUI_PENGOLINCOINGUI_H
#define PENGOLINCOIN_CORE_NEW_GUI_PENGOLINCOINGUI_H
...
#include "qt/pengolincoin/navmenuwidget.h"
...
/**
  PENGOLINCOIN GUI main class. This class represents the main window of the PENGOLINCOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PENGOLINCOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PENGOLINCOINGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PENGOLINCOINGUI();
...
#endif //PENGOLINCOIN_CORE_NEW_GUI_PENGOLINCOINGUI_H
