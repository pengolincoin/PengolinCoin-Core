...
#include "qt/pengolincoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(PENGOLINCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &PENGOLINCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
