...
#include "qt/pengolincoin/forms/ui_coldstakingwidget.h"
#include "qt/pengolincoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/pengolincoin/requestdialog.h"
...
#include "qt/pengolincoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(PENGOLINCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your PGOs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept PGO delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select PGO outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 PGO" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
