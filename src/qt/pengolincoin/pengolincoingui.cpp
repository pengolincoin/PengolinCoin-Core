...
PENGOLINCOINGUI::PENGOLINCOINGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void PENGOLINCOINGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &PENGOLINCOINGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &PENGOLINCOINGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &PENGOLINCOINGUI::showHide);
    ...
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &PENGOLINCOINGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &PENGOLINCOINGUI::execDialog);
}
...
#ifndef Q_OS_MAC
void PENGOLINCOINGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void PENGOLINCOINGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
void PENGOLINCOINGUI::goToSettings(){
...
bool PENGOLINCOINGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    connect(addressesWidget, &AddressesWidget::message,this, &PENGOLINCOINGUI::message);
...
static bool ThreadSafeMessageBox(PENGOLINCOINGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
