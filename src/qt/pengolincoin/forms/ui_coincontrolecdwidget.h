/********************************************************************************
** Form generated from reading UI file 'coincontrolpgowidget.ui'
**
...
#ifndef UI_COINCONTROLPGOWIDGET_H
#define UI_COINCONTROLPGOWIDGET_H
...
public:
    ...
    void setupUi(QWidget *CoinControlPgoWidget)
    {
        if (CoinControlPgoWidget->objectName().isEmpty())
            CoinControlPgoWidget->setObjectName(QStringLiteral("CoinControlPgoWidget"));
        CoinControlPgoWidget->resize(918, 552);
        CoinControlPgoWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlPgoWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlPgoWidget);
        ...
        retranslateUi(CoinControlPgoWidget);

        QMetaObject::connectSlotsByName(CoinControlPgoWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlPgoWidget)
    {
        CoinControlPgoWidget->setWindowTitle(QApplication::translate("CoinControlPgoWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlPgoWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlPgoWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlPgoWidget", "PGO:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlPgoWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlPgoWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlPgoWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlPgoWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlPgoWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlPgoWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlPgoWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlPgoWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlPgoWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlPgoWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlPgoWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlPgoWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlPgoWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlPgoWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlPgoWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlPgoWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlPgoWidget: public Ui_CoinControlPgoWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLPGOWIDGET_H
