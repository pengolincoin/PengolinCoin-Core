...
#include <QWidget>
#include <QString>
#include "qt/pengolincoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(PENGOLINCOINGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    PENGOLINCOINGUI* getWindow() { return this->window; }
