...
#include "qt/pengolincoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(PENGOLINCOINGUI* parent);
    ~SendWidget();
...
private slots:
    void onPGOSelected(bool _isPGO);
    void onSendClicked();
...
private:
    ...
    bool sendZpgo(QList<SendCoinsRecipient> recipients);
