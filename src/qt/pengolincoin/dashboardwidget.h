...
#include "config/pengolincoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalPgo = 0;
    qint64 totalZpgo = 0;
    QList<qreal> valuesPgo;
    QList<qreal> valueszPgo;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(PENGOLINCOINGUI* _window);
    ~DashboardWidget();
