...
#include "qt/pengolincoin/furabstractlistitemdelegate.h"
#include "qt/pengolincoin/txviewholder.h"
#include "qt/pengolincoin/tooltipmenu.h"
#include "qt/pengolincoin/sendmultirow.h"
#include "qt/pengolincoin/coldstakingmodel.h"
#include "qt/pengolincoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(PENGOLINCOINGUI* parent);
    ~ColdStakingWidget();
