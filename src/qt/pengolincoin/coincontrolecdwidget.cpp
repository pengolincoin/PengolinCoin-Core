...
#include "qt/pengolincoin/forms/ui_coincontrolpgowidget.h"

CoinControlPgoWidget::CoinControlPgoWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlPgoWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select PGO Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("PGO");
    ...
    ui->labelValueAfter->setText("0.00 PGO");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 PGO");
    ui->labelValueFee->setText("0.00 PGO");
...
CoinControlPgoWidget::~CoinControlPgoWidget()
{
    delete ui;
}
