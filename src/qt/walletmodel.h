...
#ifndef PENGOLINCOIN_QT_WALLETMODEL_H
#define PENGOLINCOIN_QT_WALLETMODEL_H
...
/** Interface to PENGOLINCOIN wallet from Qt view code. */
...
#endif // PENGOLINCOIN_QT_WALLETMODEL_H
