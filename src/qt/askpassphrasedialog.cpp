...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR PGO</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                PENGOLINCOINGUI* window = static_cast<PENGOLINCOINGUI*>(parentWidget());
...
{
    PENGOLINCOINGUI* gui = static_cast<PENGOLINCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<PENGOLINCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
