...
/** Utility functions used by the PENGOLINCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render PENGOLINCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZpgo = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZpgo = false);
...
// Parse "pengolincoin:" URI into recipient object, return true on successful parsing
