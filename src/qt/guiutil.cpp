...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a PENGOLINCOIN address (e.g. %1)").arg("E7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
bool openConfigfile()
{
    ...
    /* Open pengolincoin.conf with the associated application */
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the pengolincoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add pengolincoin app to startup item list
