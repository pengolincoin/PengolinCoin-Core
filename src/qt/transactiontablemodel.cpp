...
public:
    ...
    static bool HasZcTxesIfNeeded(const TransactionRecord& record) {
        return (record.type == TransactionRecord::ZerocoinMint ||
                ...
                record.type == TransactionRecord::ZerocoinSpend_Change_zPgo ||
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeZPGO:
        return tr("zPGO Stake");
    case TransactionRecord::StakeDelegated:
        return tr("PGO Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("PGO Stake in behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted PGO to zPGO");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zPGO");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received PGO from zPGO");
    case TransactionRecord::ZerocoinSpend_Change_zPgo:
        return tr("Minted Change as zPGO from zPGO Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zPGO to PGO");
    default:
        return QString();
    }
}
...
{
    QString str = BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->pgo + wtx->debit, false, separators);
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::EditRole:
        ...
        case Amount:
            return qint64(rec->pgo + rec->debit);
        }
        break;
    case Qt::ToolTipRole:
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZPGO || rec->type == TransactionRecord::MNReward) {
        ...
        if (index.column() == Amount && (rec->pgo + rec->debit) < 0) {
