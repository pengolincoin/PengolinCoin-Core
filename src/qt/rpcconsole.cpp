                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPGOPathCustom = GetArg("-zpgobackuppath", "");
    ...
    if(!strzPGOPathCustom.empty()) {
        ui->wallet_customzpgobackuppath->setText(QString::fromStdString(strzPGOPathCustom));
        ui->wallet_customzpgobackuppath_label->setVisible(true);
        ui->wallet_customzpgobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPGOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PENGOLINCOIN RPC console.") + "<br>" +
