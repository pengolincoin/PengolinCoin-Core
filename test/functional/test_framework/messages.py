...
COIN = 100000000 # 1 PGO in satoshis
...
# Objects that map to pengolincoind objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in pengolincoind indicates these should be deserialized as blocks
