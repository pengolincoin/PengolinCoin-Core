...
class DIP3Test(PengolinCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 PGO) to the operator, and (2 * 2.7 PGO) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid PENGOLINCOIN address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid PENGOLINCOIN address InvalidPayee", controller.protx_update_registrar,
