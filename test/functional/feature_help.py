...
"""Verify that starting pengolincoin with -h works as expected."""
...
class HelpTest(PengolinCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pengolincoin with -? for help text")
        ...
        self.log.info("Start pengolincoin with -version for version information")
