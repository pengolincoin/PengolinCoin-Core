...
from fake_stake.base_test import PENGOLINCOIN_FakeStakeTest

class zPGOwrappedSerialsTest(PENGOLINCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPGOs..." % DENOM_TO_USE)
