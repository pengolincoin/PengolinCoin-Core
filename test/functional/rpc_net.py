...
class NetTest(PengolinCoinTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 33001)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 33001)
