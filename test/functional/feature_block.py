...
class FullBlockTest(PengolinCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure pengolincoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure pengolincoind isn't accepting b28
        ...
        # PENGOLINCOIN: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the pengolincoin code has custom code which does so);
