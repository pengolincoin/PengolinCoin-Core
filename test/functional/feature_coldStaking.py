...
from test_framework.pengolincoin_node import PengolinCoinTestNode
...
class PENGOLINCOIN_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(PengolinCoinTestNode())
...
if __name__ == '__main__':
    PENGOLINCOIN_ColdStakingTest().main()
