...
class ListReceivedTest (PengolinCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 PGO.
        ...
        # Send 1 PGO to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 PGO sending them all (fee is 0.1 PGO)
        ...
        # Confirm transaction (2 PGO from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 PGO, send 0.6 PGO + 0.05 PGO fee
