...
from test_framework.test_framework import PengolinCoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(PengolinCoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.pengolincoin.xyz/t/test-proposal"
