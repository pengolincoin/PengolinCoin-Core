UNIX BUILD NOTES
====================
Some notes on how to build PENGOLINCOIN Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile PENGOLINCOIN Core and the dependencies,
...
This will build pengolincoin-qt as well, if the dependencies are met.
...
memory available when compiling PENGOLINCOIN Core. On systems with less, gcc can be
...
If you want to build pengolincoin-qt, make sure that the required packages for Qt development
...
Notes
-----
The release is built with GCC and then "strip pengolincoind" to strip the debug
...
Security
--------
To help make your PENGOLINCOIN Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, PENGOLINCOIN Core should be built with a non-executable stack
