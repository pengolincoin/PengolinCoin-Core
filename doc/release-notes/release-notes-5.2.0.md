PENGOLINCOIN Core version v5.2.0 is now available from:  <https://github.com/pengolincoin-project/pengolincoin/releases>
...
PENGOLINCOIN Core v5.2.0 is a mandatory update for all users. This release contains a protocol upgrade (to `30001`), new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
...
For the other packages, the user must save the param files in the proper location, before being able to run PENGOLINCOIN v5.2.0:
...
- #2431 [Consensus] Bump active protocol version to 30001 (random-zebra)
