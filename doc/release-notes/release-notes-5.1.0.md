PENGOLINCOIN Core version v5.1.0 is now available from:  <https://github.com/pengolincoin-project/pengolincoin/releases>
...
- #2249 Make box of PENGOLINCOIN Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better pengolincoin.conf Masternode data error notification (furszy)
