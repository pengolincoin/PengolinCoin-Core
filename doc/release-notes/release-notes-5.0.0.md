PENGOLINCOIN Core version *v5.0.0* is now available from:  <https://github.com/pengolincoin-project/pengolincoin/releases>
...
PENGOLINCOIN Core v5.0.0 is a mandatory update for all users. This release contains a protocol upgrade (to `70920`), new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
...
More visual information about the protocol can be found at https://pengolincoin.xyz .
...
See the release notes from [v4.2.0](https://github.com/PENGOLINCOIN-Project/PENGOLINCOIN/blob/master/doc/release-notes/release-notes-4.2.0.md#label-and-account-apis-for-wallet) for a full description of the changes from the 'account' API to the 'label' API.
...
* `viewshieldtransaction`
  ...
  Result:
  {
    ...
    "fee"  : x.xxx,             (numeric) The transaction fee in PGO
    "spends" : [
      {
        ...
        "value" : x.xxx                 (numeric) The amount in PGO
...
### Build Systems
- #1856 `1bbb906059` [CMake] Add test_pengolincoin unit test target (Fuzzbawls)
...
- #2041 `a15dc3417d` [Build] CMake pengolincoind and unit tests: fixing missing MacOS framework. (furszy)
