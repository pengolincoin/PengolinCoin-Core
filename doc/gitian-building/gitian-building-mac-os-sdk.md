...
The script [extract-osx-sdk.sh](https://github.com/pengolincoin-project/pengolincoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
pengolincoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/pengolincoin-project/pengolincoin/blob/master/doc/README_osx.md) for troubleshooting tips.