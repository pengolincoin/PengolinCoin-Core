...
The build script we'll be using is contained in the PENGOLINCOIN github repository ([contrib/gitian-build.py](https://github.com/pengolincoin-project/pengolincoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the PENGOLINCOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/PENGOLINCOIN-Project/PENGOLINCOIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, pengolincoin-detached-sigs, and pengolincoin GitHub repos.
